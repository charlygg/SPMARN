      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="tramites.php"><i class="fa fa-link"></i><span>Tramites</span></a></li>
            <!--
            <li class="treeview">
      ...
      <div class="content-wrapper">
		...
		?>		
                ...
                <div class="box-body">
					...
					$resultado = $mysqli->query("call testsecurity.sp_reporte_tramites_generico(1,'$fechaInicial','$fechaTermino')");
