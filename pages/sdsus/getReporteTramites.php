...
$filtroTramite = $_POST['filtroTramite'];
...
$resultado = $mysqli->query("call testsecurity.sp_reporte_tramites_excel(1, '$fechaInicial', '$fechaTermino', '$filtroTramite', '$filtroArea' , '$filtroEmpresa')");
