  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<?php
        $departamento = $_SESSION['session_user_depto_id'];
        
		switch($departamento){
			case 1: 
				echo "<p>Este es el departamento de Recepcion el switch funciona</p>";
				/* Se extraera en cada una de las tablas de los tramites el estatus nuevo para recepcion y se mostrara en un cuadro resumido*/
        ...
        <div class="box">
       	...
       	<section class="content">
       		<div class="box">
       			<div class="box-header with-border">
                  <h3 class="box-title">Tramites recientes</h3>
                </div>
       			<div class="box-body">
